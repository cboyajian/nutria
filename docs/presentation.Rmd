...
- Alex: Navigator
Diving into metadata, finding hurricane dates, helping with plot direction

- Austin: Git Guru
Solving merge conflicts, controlling versions, and keeping the team afloat

- Clarissa: Captain


- Cullen: ggplot Wizard
